...
#include "utility.h"
#include "shared.h"
//extern ALLEGRO_SAMPLE_ID gameBGM;
...
static void init() {
	...
	//	Uncomment and fill the code below
    background = button_create(0, 0, 1200, 1200, "Assets/menu.jpg", "Assets/menu.jpg");
	btnSettings = button_create(1100, 25, 70, 70, "Assets/settings.png", "Assets/settings2.png");
